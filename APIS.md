...
| `/` | GET | List collaborations where user is requester or influencer. Supports `?status=`, `?search=`, `?page=`, `?limit=` query params. Returns paginated response. | N/A |
...
| `/v1/uploads` | Direct-to-S3 uploads (Max 200MB) |
