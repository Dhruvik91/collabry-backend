...
export class NotificationsController {
    ...
    async subscribe(
        ...
        await this.notificationsService.registerSubscription(req.user.id, subscribeDto, userAgent);
    ...
    async unsubscribe(
        ...
        await this.notificationsService.unregisterSubscription(unsubscribeDto.endpoint);
