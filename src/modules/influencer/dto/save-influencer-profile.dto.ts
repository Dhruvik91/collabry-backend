...
export class SaveInfluencerProfileDto {
  ...
  @ApiPropertyOptional({
    example: "Passionate content creator focused on lifestyle and wellness",
  })
  @IsOptional()
  @IsString()
  bio?: string;
  ...
  @ApiPropertyOptional({
    example: {
      instagram: { handle: "@johndoe", followers: 10000, engagementRate: 4.5 },
    },
  })
  @IsOptional()
  @IsObject()
  ...
  @ApiPropertyOptional({
    ...
    example: AvailabilityStatus.OPEN,
  })
  @IsOptional()
