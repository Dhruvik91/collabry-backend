...
export class AuctionController {
  ...
  @ApiOkResponseEnvelope(Auction, true)
  @ApiUnauthorizedResponseEnvelope()
  findMyAuctions(@Req() req: any, @Query() query: AuctionQueryDto) {
    return this.auctionService.findMyAuctions(
      req.user.id,
      query.page,
      query.limit,
      query.search,
  ...
  @ApiUnauthorizedResponseEnvelope()
  findMyBids(@Req() req: any, @Query() query: AuctionQueryDto) {
    return this.auctionService.findMyBids(
      req.user.id,
      query.page,
      query.limit,
      query.search,
  ...
  @ApiUnauthorizedResponseEnvelope()
  @ApiForbiddenResponseEnvelope(
    "You do not have permission to delete this auction",
  )
  @ApiNotFoundResponseEnvelope("Auction not found")
  ...
  @Roles(UserRole.USER)
  @ApiOperation({
    summary: "Accept a bid and create collaboration (Brand only)",
  })
