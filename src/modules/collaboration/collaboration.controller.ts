...
export class CollaborationController {
  ...
  @ApiUnauthorizedResponseEnvelope()
  async getMyInfluencers(
    @Req() req: any,
    @Query() filters: FilterMyInfluencersDto,
  ) {
  ...
  async updateStatus(
    @Req() req: any,
    @Param("id") id: string,
    @Body() statusDto: UpdateCollaborationStatusDto,
  ) {
  ...
  async update(
    @Req() req: any,
    @Param("id") id: string,
    @Body() updateDto: UpdateCollaborationDto,
  ) {
  ...
  @ApiUnauthorizedResponseEnvelope()
  @ApiForbiddenResponseEnvelope(
    "You do not have permission to delete this collaboration",
  )
  @ApiNotFoundResponseEnvelope("Collaboration not found")
