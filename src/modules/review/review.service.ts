...
export class ReviewService {
  ...
  async createReview(
    ...
    if (!collaboration) {
      throw new BadRequestException(
        "No valid collaboration found to review. You must have a collaboration with this influencer.",
      );
    }
    ...
    try {
      ...
      this.logger.error(
        `Failed to update ranking after review: ${error.message}`,
      );
  ...
  private async updateInfluencerAverageRating(
