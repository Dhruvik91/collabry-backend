...
export class PaymentCleanupService {
    ...
    async handleAbandonedOrders() {
        ...
        this.logger.log(`Found ${abandonedOrders.length} abandoned PENDING orders to clean up.`);
        ...
        this.logger.log(`Successfully auto-cancelled ${abandonedOrders.length} stale orders.`);
    }
}
