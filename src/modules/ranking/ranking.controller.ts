...
export class RankingController {
  ...
  @ApiOperation({
    ...
    description:
      "Triggers immediate ranking recalculation for the specified influencer",
  })
  @ApiParam({
    name: "influencerId",
    description: "User ID of the influencer",
  ...
  @ApiOperation({
    ...
    description:
      "Triggers ranking recalculation for all influencers in the system",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Returns comprehensive guide on all ranking tiers, requirements, and how to earn points",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Returns the current weight configuration used for ranking calculations",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Updates the weight configuration used for ranking calculations",
  })
