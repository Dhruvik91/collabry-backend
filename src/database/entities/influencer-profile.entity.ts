...
export class InfluencerProfile {
  ...
  @ApiProperty({
    description:
      "Platform data with handle, followers, and engagementRate per platform",
  })
  ...
  @ApiProperty({
    description: "Audience gender ratio, e.g., { male: 0.4, female: 0.6 }",
  })
  @Column({ type: "jsonb", nullable: true })
  audienceGenderRatio: any;

  @ApiProperty({
    description: 'Audience age brackets, e.g., { "18-24": 0.3, "25-34": 0.5 }',
  })
  @Column({ type: "jsonb", nullable: true })
